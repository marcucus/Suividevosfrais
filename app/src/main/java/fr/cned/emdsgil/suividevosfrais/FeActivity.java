...
public class FeActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Global.changeAfficheDate((DatePicker) findViewById(R.id.datFe), false) ;
	...
	private void valoriseProprietes() {
		annee = ((DatePicker)findViewById(R.id.datFe)).getYear() ;
		mois = ((DatePicker)findViewById(R.id.datFe)).getMonth() + 1 ;
    ...
    private void imgReturn_clic() {
    	findViewById(R.id.imgFeReturn).setOnClickListener(new ImageView.OnClickListener() {
    ...
    private void cmdValider_clic() {
    	findViewById(R.id.cmdFeValider).setOnClickListener(new Button.OnClickListener() {
    		public void onClick(View v) {
    			Serializer.serialize(Global.listFraisMois, FeActivity.this) ;
    			retourActivityPrincipale() ;    		
    		}
    	}) ;    	
    }
    ...
    private void dat_clic() {   	
    	final DatePicker uneDate = (DatePicker) findViewById(R.id.datFe);
	...
	private void retourActivityPrincipale() {
		Intent intent = new Intent(FeActivity.this, MainActivity.class) ;
